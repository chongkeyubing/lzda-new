...
@Table(name = "arc_family_abroad_investment")
public class ArcFamilyAbroadInvestment {
    /**
     * 主键
     */
    @Id
...
6纪委审核驳回
     ...
     * 获取投资人称谓
     *
     * @return family_appellation - 投资人称谓
     */
...
6纪委审核驳回
    ...
    /**
     * 获取档案类型：在国（境）外的投资情况，固定值18无需填写
     *
     * @return archive_type - 档案类型：在国（境）外的投资情况，固定值18无需填写
     */
    ...
    /**
     * 设置档案类型：在国（境）外的投资情况，固定值18无需填写
     *
     * @param archiveType 档案类型：在国（境）外的投资情况，固定值18无需填写
     */
