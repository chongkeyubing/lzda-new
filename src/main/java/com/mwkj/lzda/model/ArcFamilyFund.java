...
@Table(name = "arc_family_fund")
public class ArcFamilyFund {
    /**
     * 主键
     */
    @Id
...
6纪委审核驳回
    ...
    /**
     * 获取档案类型：持有基金的情况，固定值15无需填写
     *
     * @return archive_type - 档案类型：持有基金的情况，固定值15无需填写
     */
    ...
    /**
     * 设置档案类型：持有基金的情况，固定值15无需填写
     *
     * @param archiveType 档案类型：持有基金的情况，固定值15无需填写
     */
