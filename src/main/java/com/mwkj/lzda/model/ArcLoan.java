...
public class ArcLoan {
    ...
    /**
     * 获取档案类型：借贷（担保）登记表，固定值27无需填写
     *
     * @return archive_type - 档案类型：借贷（担保）登记表，固定值27无需填写
     */
    ...
    /**
     * 设置档案类型：借贷（担保）登记表，固定值27无需填写
     *
     * @param archiveType 档案类型：借贷（担保）登记表，固定值27无需填写
     */
