...
<div style="display: flex; justify-content: center;">
    <form class='layui-form form1' action='arcfamilyfund/add' id="archiveForm" method="post">
        <div class="layui-form-item">
            ...
            <div class='layui-inline'>
                <label class='layui-form-label'>基金名称或代码</label>
                <div class='layui-input-inline input'>
                    <input type='text' name='fundName' lay-verify="required" placeholder='' autocomplete='off'
                           class='layui-input' value="">
                </div>
            </div>
        </div>
        ...
        <div class='layui-form-item'>
            <div class='layui-inline'>
                <label class='layui-form-label'>基金份额</label>
                <div class='layui-input-inline input'>
                    <input type='text' name='fundNumber' lay-verify="required|number" placeholder='' autocomplete='off'
                           class='layui-input' value="">
                </div>
            </div>
            <div class='layui-inline'>
                <label class='layui-form-label label'>填报前一交易日净值（万元）</label>
                <div class='layui-input-inline'>
            ...
            <%--<div class='layui-inline'>--%>
            <%--<label class='layui-form-label'>填报前一交易日所有基金的总市值（万元）</label>--%>
            <%--<div class='layui-input-inline input'>--%>
