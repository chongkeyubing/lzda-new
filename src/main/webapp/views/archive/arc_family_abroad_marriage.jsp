...
<div style="display: flex; justify-content: center;">
    <form class='layui-form form1' action='arcfamilyabroadmarriage/add' id="archiveForm" method="post">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">配偶国家</label>
                <div class="layui-input-inline">
                    <input type="text" name="partnerNation" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>

            <div class="layui-inline">
                <label class="layui-form-label">配偶职务</label>
                <div class="layui-input-inline">
