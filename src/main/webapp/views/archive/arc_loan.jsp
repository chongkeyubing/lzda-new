...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        $("#addLoan").click(function () {
            ...
            tempStr += "</div>"
            tempStr += "<div class='layui-inline'>"
            tempStr += "<label class='layui-form-label'>金额（元）</label>"
            tempStr += "<div class='layui-input-inline'>"
        ...
        $("#addActivity").click(function () {
            ...
            tempStr += "<div class='layui-input-inline'>"
            tempStr += "<input type='text' name='activitys[" + activityIndex + "].enterpriseName' autocomplete='off' lay-verify='required' class='layui-input'>"
            tempStr += "</div>"
            tempStr += "</div>"
            ...
            tempStr += "<div class='layui-inline'>"
            tempStr += "<label class='layui-form-label'>投入金额（元）</label>"
            tempStr += "<div class='layui-input-inline'>"
            tempStr += "<input type='text' name='activitys[" + activityIndex + "].amount' lay-verify='required|number' autocomplete='off' class='layui-input'>"
            tempStr += "</div>"
            tempStr += "</div>"
            tempStr += "</div>"
            tempStr += "<div class='layui-form-item'>"
            ...
            tempStr += "<label class='layui-form-label'>资金来源</label>"
            tempStr += "<div class='layui-input-inline'>"
            tempStr += "<input type='text' name='activitys[" + activityIndex + "].fundSource' lay-verify='required' autocomplete='off' class='layui-input'>"
            tempStr += "</div>"
            tempStr += "</div>"
            ...
            tempStr +="  <div class='layui-input-inline'>"
            tempStr +="<textarea placeholder='请输入内容' class='layui-textarea txtArea' lay-verify='required' name='activitys[" + activityIndex + "].profit'></textarea>"
            tempStr +="</div>"
            tempStr +="</div>"
