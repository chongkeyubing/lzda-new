    ...
    <form class='layui-form form1' action='arcpersonalother/add' id="archiveForm" method="post">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-inline area">
                <textarea placeholder="请输入内容" name="promise" class="layui-textarea txtArea" style="text-indent: 2em;">我已认真学习《领导干部报告个人有关事项规定》和《领导干部个人有关事项报告查核结果处理办法》，认真阅读《填表须知和每一事项表格下方的填表说明，所填内容已与配偶、子女及其配偶进行了认真核实。我郑重承诺，本人对以上所填内容的真实性和完整性负责，井自愿接受组织监督和查核。</textarea>
            </div>
        </div>
