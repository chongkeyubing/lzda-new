    ...
    layui.use(['form', 'table', 'layer', 'laydate'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[ //表头
                ...
                {field: 'violationLevel', title: '违纪级别'},
                {field: 'violationType', title: '违纪类型'},
                {
                    field: 'createTime',
                    title: '填表时间',
        ...
        //明细按钮监听
        table.on('tool(punViolationListTable)', function (obj) {
            if (obj.event === 'detail') {
                $.get('punish/toPunishDetail?punishType=1&punishId=' + obj.data.id, function (html) {
                    layer.open({
                        type: 1,
                        title: obj.data.violationType + "-" + obj.data.userName,
                        area: ['100%', '100%'],
                        content: html
                    });
                });
