    ...
    <form class="layui-form form1" action="rptincorrupt/add" id="reportForm" method="post">
        ...
        <div class="layui-form-item" >
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" id="title" lay-filter="queryReport" lay-verify="required"
                       autocomplete="off" placeholder="请输入标题" style="width: 818px;" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">内容</label>
            <div class="layui-input-inline">
                <textarea placeholder="请输入内容" lay-filter="queryReport" lay-verify="required" name="content" id="content"
