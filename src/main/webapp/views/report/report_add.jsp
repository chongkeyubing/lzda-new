		...
		<form class="layui-form form1" action="rptincorrupt/add" id="reportFrom" method="post">
			...
			<div class="layui-form-item" style="margin-left: 2px;">
				...
				<div class="layui-input-block">
					<input type="text" name="title" id="title" lay-verify="title" autocomplete="off" placeholder="请输入标题" style="width: 75%;" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">内容</label>
				<div class="layui-input-block area">
					<textarea placeholder="请输入内容" name="content" id="content" class="layui-textarea txtArea"></textarea>
				</div>
			</div>
