		...
		<wx:sect>
			...
			<w:p>
				<w:pPr>
					...
					<w:adjustRightInd/>
					<w:snapToGrid/>
					<w:spacing w:before="156" w:before-lines="50" w:line="480" w:line-rule="auto"/>
					...
					<w:rPr>
						<w:rStyle w:val="a10"/>
						<w:rFonts w:ascii="新宋体" w:h-ansi="新宋体" w:fareast="新宋体" w:cs="新宋体" w:hint="fareast"/>
						<w:b/>
						<w:sz-cs w:val="22"/>
						<w:lang w:val="EN-US" w:fareast="ZH-CN"/>
					</w:rPr>
